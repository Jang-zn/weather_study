...
import 'package:weather_study/utils/date_utils.dart';
import 'package:weather_study/utils/forecast_animation_utils.dart';
import 'package:weather_study/widget/color_transition_icon.dart';
              ...
              TableCell(
                child: Padding(
                  ...
                  child: ColorTransitionText(
                    text: Date_Utils.weekdays[dailyWeather.dateTime.weekday],
                    style: textStyle,
